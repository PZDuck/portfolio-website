export default [
  {
    ...
    description: [
      ...
      "Designed and developed a Single Page Application with ReactJS and ExpressJS",
      "Utilized web sockets to support bi-directional communication between web clients and the server in real time",
    ],
    tech: ["JS", "React", "Node.js", "Socket.io", "HTML5", "CSS3", "SCSS"],
    tech_img: [
  ...
  },
  {
    ...
    description: [
      ...
      "Designed and created the application’s frontend with a Python templating engine Jinja2",
    ],
    tech: ["Python", "Flask", "MongoDB", "HTML5", "CSS3"],
    tech_img: [
  ...
  },
  {
    ...
    description: [
      ...
      "Developed the backend logic using Python Flask web framework and frontend with Jinja2 templating language",
    ],
  ...
  },
  {
    ...
    description: [
      ...
      "Developed the backend logic and RESTful API with the use of Python Django framework",
    ],
    tech: ["Python", "Django", "React", "PostgreSQL", "HTML5", "CSS3"],
    tech_img: [
